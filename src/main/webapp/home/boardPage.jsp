...
if (request.getAttribute("bList") == null) {//강제로 접근시 서블릿으로 보내는 기능
	response.sendRedirect("/board/boardListServlet.do");
	return;
}
...
<body>
	...
	<main class="boardPage">
		...
		<article class="article3">
			<div class="all">
				<form method="get" action="/board/boardListServlet.do">
				...
				<form method="get" action="/board/boardFindListServlet.do">
		...
		<article class="article4">
			<table>
				...
				<tr>
					...
					<td class="tbMain"><a
						href=" <%=request.getContextPath()%>/boardContentSelectServlet.do?no=<%=data.getNo()%>"><%=data.getTitle()%></a>&nbsp;&nbsp; [<%=cmDAO.selectCountByBoardNoDB(data) %>]</td>
