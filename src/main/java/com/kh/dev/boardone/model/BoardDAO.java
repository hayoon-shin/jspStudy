package com.kh.dev.boardone.model;
...
import com.kh.dev.memberone.model.StudentVO;
...
public class BoardDAO {
	...
	public ArrayList<BoardVO> selectStartEndDB(int start, int end) {
		...
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<BoardVO> boardList = new ArrayList<BoardVO>(end-start+1); // arrayList 갯수를 미리 정해주는 것
		try {
